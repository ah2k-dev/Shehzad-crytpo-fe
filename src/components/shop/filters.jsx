...
const Filters = () => {
  ...
  return (
    <div>
      <p className="text-xl text-blackcurrent-600 font-medium mb-3">
        Categories :
      </p>
          ...
          <Radio
            ...
            classNames={{
              base: cn(
                ...
                "data-[selected=true]:bg-blackcurrent-100"
              ),
            }}
          >
            {value}
      ...
      <p className="text-xl text-blackcurrent-600 font-medium my-3">
        Price :
      </p>
